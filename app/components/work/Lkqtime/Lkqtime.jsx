...
const Lkqtime = () => {
    ...
    const Lkqtimeimgs = [
        ...
        'https://vanleeuwenmedia.s3.eu-central-1.amazonaws.com/LKQtime/LKQtime2.jpg',
        'https://vanleeuwenmedia.s3.eu-central-1.amazonaws.com/LKQtime/LKQtime3.jpg',
    ...
    return (
        <>
            <Slider {...settings}>
                {Lkqtimeimgs.map((Lkqtimeimgs, index) => (
